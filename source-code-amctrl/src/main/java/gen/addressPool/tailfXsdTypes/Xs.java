 ...
 * TailfXsdTypes.NAMESPACE) with prefix "xs" (TailfXsdTypes.PREFIX).
 *
...
public class Xs {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "gen.addressPool.tailfXsdTypes");
        Xs.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
		...
		String filepath = Xs.class.getResource("/").getPath()+"schema/Xs.schema"; 
        parser.readFile(filepath, h);
        //parser.readFile("src/gen/addressPool/tailfXsdTypes/Xs.schema", h);
    }
