...
public class Inet {
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "gen.addressPool.ietfInetTypes");
        Inet.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
		...
		String filepath = Inet.class.getResource("/").getPath()+"schema/Inet.schema"; 
        parser.readFile(filepath, h);
        //parser.readFile("src/gen/addressPool/ietfInetTypes/Inet.schema", h);
    }
