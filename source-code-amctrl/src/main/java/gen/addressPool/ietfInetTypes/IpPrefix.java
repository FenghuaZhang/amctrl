 ...
 * the namespace 
 * generated to "src/gen/addressPool/ietfInetTypes/ip-prefix"
 * <p>
 * See line 288 in
...
public class IpPrefix extends YangUnion {
    ...
    public IpPrefix(String value) throws YangException {
        super(value,
            new String[] {
                "gen.addressPool.ietfInetTypes.Ipv4Prefix",
                "gen.addressPool.ietfInetTypes.Ipv6Prefix",
            }
        );
        check();
    }
