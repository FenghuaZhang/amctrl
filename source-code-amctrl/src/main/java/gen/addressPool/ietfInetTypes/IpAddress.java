 ...
 * the namespace 
 * generated to "src/gen/addressPool/ietfInetTypes/ip-address"
 * <p>
 * See line 179 in
...
public class IpAddress extends YangUnion {
    ...
    public IpAddress(String value) throws YangException {
        super(value,
            new String[] {
                "gen.addressPool.ietfInetTypes.Ipv4Address",
                "gen.addressPool.ietfInetTypes.Ipv6Address",
            }
        );
        check();
    }
